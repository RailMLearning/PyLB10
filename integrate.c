...
/*--- Type declarations ---*/
struct __pyx_opt_args_9integrate_integrate_sin_nogil;
struct __pyx_opt_args_9integrate_integrate_sin;
...
static double __pyx_f_9integrate__integrate_sin_nogil(double, double, int); /*proto*/
static double __pyx_f_9integrate_integrate_sin_nogil(double, double, int __pyx_skip_dispatch, struct __pyx_opt_args_9integrate_integrate_sin_nogil *__pyx_optional_args); /*proto*/
static double __pyx_f_9integrate_integrate_sin(double, double, int __pyx_skip_dispatch, struct __pyx_opt_args_9integrate_integrate_sin *__pyx_optional_args); /*proto*/
...
/* #### Code section: decls ### */
static PyObject *__pyx_pf_9integrate_integrate_sin_nogil(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_a, double __pyx_v_b, int __pyx_v_n_iter); /* proto */
static PyObject *__pyx_pf_9integrate_2integrate_sin(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_a, double __pyx_v_b, int __pyx_v_n_iter); /* proto */
...
#define __pyx_n_u_integrate __pyx_string_tab[8]
#define __pyx_n_u_integrate_sin __pyx_string_tab[9]
...
#define __pyx_kp_b_iso88591_1Cs __pyx_string_tab[23]
#define __pyx_kp_b_iso88591_a_Cr_U_1_Bb_A_s_3b_1 __pyx_string_tab[24]
...
static double __pyx_f_9integrate__integrate_sin_nogil(double __pyx_v_a, double __pyx_v_b, int __pyx_v_n_iter) {
  double __pyx_v_acc;
  double __pyx_v_step;
  int __pyx_v_i;
  double __pyx_v_x;
...
static PyObject *__pyx_pw_9integrate_1integrate_sin_nogil(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static double __pyx_f_9integrate_integrate_sin_nogil(double __pyx_v_a, double __pyx_v_b, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_9integrate_integrate_sin_nogil *__pyx_optional_args) {
 ...
 * #      ( )
*/
        __pyx_t_1 = __pyx_f_9integrate__integrate_sin_nogil(__pyx_v_a, __pyx_v_b, __pyx_v_n_iter); if (unlikely(__pyx_t_1 == ((double)-1) && __Pyx_ErrOccurredWithGIL())) __PYX_ERR(0, 23, __pyx_L4_error)
        __pyx_r = __pyx_t_1;
...
*/
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("integrate.integrate_sin_nogil", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  return __pyx_r;
}
...
static PyMethodDef __pyx_mdef_9integrate_1integrate_sin_nogil = {"integrate_sin_nogil", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_9integrate_1integrate_sin_nogil, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_9integrate_1integrate_sin_nogil(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "integrate_sin_nogil", 0) < (0)) __PYX_ERR(0, 21, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 2; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("integrate_sin_nogil", 0, 2, 3, i); __PYX_ERR(0, 21, __pyx_L3_error) }
      }
    } else {
      switch (__pyx_nargs) {
        case  3:
    ...
    if (values[2]) {
      __pyx_v_n_iter = __Pyx_PyLong_As_int(values[2]); if (unlikely((__pyx_v_n_iter == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 21, __pyx_L3_error)
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("integrate_sin_nogil", 0, 2, 3, __pyx_nargs); __PYX_ERR(0, 21, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __pyx_r = __pyx_pf_9integrate_integrate_sin_nogil(__pyx_self, __pyx_v_a, __pyx_v_b, __pyx_v_n_iter);
...
static PyObject *__pyx_pf_9integrate_integrate_sin_nogil(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_a, double __pyx_v_b, int __pyx_v_n_iter) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  double __pyx_t_1;
  struct __pyx_opt_args_9integrate_integrate_sin_nogil __pyx_t_2;
  ...
  __pyx_t_1 = __pyx_f_9integrate_integrate_sin_nogil(__pyx_v_a, __pyx_v_b, 1, &__pyx_t_2); if (unlikely(__pyx_t_1 == ((double)-1) && PyErr_Occurred())) __PYX_ERR(0, 21, __pyx_L1_error)
...
static PyObject *__pyx_pw_9integrate_3integrate_sin(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
static double __pyx_f_9integrate_integrate_sin(double __pyx_v_a, double __pyx_v_b, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_9integrate_integrate_sin *__pyx_optional_args) {
  int __pyx_v_n_iter = ((int)0x186A0);
  double __pyx_v_acc;
  double __pyx_v_step;
  int __pyx_v_i;
...
static PyMethodDef __pyx_mdef_9integrate_3integrate_sin = {"integrate_sin", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_9integrate_3integrate_sin, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_9integrate_3integrate_sin(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      const Py_ssize_t kwd_pos_args = __pyx_nargs;
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "integrate_sin", 0) < (0)) __PYX_ERR(0, 26, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 2; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("integrate_sin", 0, 2, 3, i); __PYX_ERR(0, 26, __pyx_L3_error) }
      }
    } else {
      switch (__pyx_nargs) {
        case  3:
    ...
    if (values[2]) {
      __pyx_v_n_iter = __Pyx_PyLong_As_int(values[2]); if (unlikely((__pyx_v_n_iter == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 26, __pyx_L3_error)
    } else {
      __pyx_v_n_iter = ((int)0x186A0);
    }
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("integrate_sin", 0, 2, 3, __pyx_nargs); __PYX_ERR(0, 26, __pyx_L3_error)
  __pyx_L6_skip:;
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  for (Py_ssize_t __pyx_temp=0; __pyx_temp < (Py_ssize_t)(sizeof(values)/sizeof(values[0])); ++__pyx_temp) {
  ...
  __Pyx_AddTraceback("integrate.integrate_sin", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9integrate_2integrate_sin(__pyx_self, __pyx_v_a, __pyx_v_b, __pyx_v_n_iter);
...
static PyObject *__pyx_pf_9integrate_2integrate_sin(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_a, double __pyx_v_b, int __pyx_v_n_iter) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  double __pyx_t_1;
  struct __pyx_opt_args_9integrate_integrate_sin __pyx_t_2;
  PyObject *__pyx_t_3 = NULL;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  ...
  __pyx_t_2.__pyx_n = 1;
  __pyx_t_2.n_iter = __pyx_v_n_iter;
  __pyx_t_1 = __pyx_f_9integrate_integrate_sin(__pyx_v_a, __pyx_v_b, 1, &__pyx_t_2); if (unlikely(__pyx_t_1 == ((double)-1) && PyErr_Occurred())) __PYX_ERR(0, 26, __pyx_L1_error)
...
__Pyx_PyMODINIT_FUNC PyInit___init__(void) { return PyInit_integrate(); }
#endif
...
__Pyx_RefNannySetupContext("PyInit_integrate", 0);
  ...
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_mstate_global->__pyx_n_u_integrate) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
 ...
 *         return _integrate_sin_nogil(a, b, n_iter)
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_9integrate_1integrate_sin_nogil, 0, __pyx_mstate_global->__pyx_n_u_integrate_sin_nogil, NULL, __pyx_mstate_global->__pyx_n_u_integrate, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  __Pyx_CyFunction_SetDefaultsTuple(__pyx_t_2, __pyx_mstate_global->__pyx_tuple[0]);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_integrate_sin_nogil, __pyx_t_2) < (0)) __PYX_ERR(0, 21, __pyx_L1_error)
 ...
 *     cdef double step = (b - a) / n_iter
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_9integrate_3integrate_sin, 0, __pyx_mstate_global->__pyx_n_u_integrate_sin, NULL, __pyx_mstate_global->__pyx_n_u_integrate, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[1])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  __Pyx_CyFunction_SetDefaultsTuple(__pyx_t_2, __pyx_mstate_global->__pyx_tuple[0]);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_integrate_sin, __pyx_t_2) < (0)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 *         return _integrate_sin_nogil(a, b, n_iter)
*/
  __pyx_mstate_global->__pyx_tuple[0] = PyTuple_Pack(1, __pyx_mstate_global->__pyx_int_100000); if (unlikely(!__pyx_mstate_global->__pyx_tuple[0])) __PYX_ERR(0, 21, __pyx_L1_error)
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 7; } index[] = {{1},{13},{20},{1},{18},{1},{18},{8},{9},{13},{19},{13},{5},{8},{10},{6},{8},{3},{12},{12},{10},{8},{6},{25},{70}};
    #if (CYTHON_COMPRESS_STRINGS) == 3 && __PYX_LIMITED_VERSION_HEX >= 0x030e0000 /* compression: zstd